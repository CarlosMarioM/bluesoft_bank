...
abstract class $ClientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String city, String uid});
}
...
class _$ClientImpl implements _Client {
  ...
  @override
  String toString() {
    return 'Client(id: $id, name: $name, city: $city, uid: $uid)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, city, uid);
...
abstract class _Client implements Client {
  const factory _Client(
      ...
      required final String uid}) = _$ClientImpl;
